...
export const PENKRA_DEVELOPMENT_ACCOUNT_AUTH_SCHEME =
  `${PENKRA_PRODUCTION_ACCOUNT_AUTH_SCHEME}.dev`;
export const PENKRA_CANARY_ACCOUNT_AUTH_SCHEME =
  `${PENKRA_PRODUCTION_ACCOUNT_AUTH_SCHEME}.canary`;
export const PENKRA_ACCOUNT_AUTH_SCHEME =
