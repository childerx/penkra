...
// the shareable activity card. All metrics are backed by Penkra's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Penkra.
...
// Token totals come from Penkra's projected context-window updates. `available`
