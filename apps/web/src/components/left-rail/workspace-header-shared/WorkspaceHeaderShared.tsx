    ...
    <div className="group/workspace-header relative w-full">
      ...
      {onAdd ? (
        <button
          ...
          className="absolute top-1/2 right-2 inline-flex size-3.5 -translate-y-1/2 cursor-pointer items-center justify-center border-0 bg-transparent p-0 text-[var(--pencil-text-secondary)] opacity-0 outline-none group-hover/workspace-header:opacity-100 hover:text-[var(--pencil-text-primary)] focus-visible:opacity-100 focus-visible:ring-1 focus-visible:ring-[var(--pencil-accent-focus)]"
          onClick={onAdd}
          type="button"
        >
