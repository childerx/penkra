...
import type { ProjectFileSystemEntry, ProjectLocalSearchEntry } from "@penkra/contracts";
    ...
    <Command autoHighlight={false} mode="none">
      <div className={COMPOSER_COMMAND_MENU_SURFACE_CLASS_NAME}>
        <div className="flex items-center gap-2 border-b border-border px-2 py-1.5">
          ...
          <span className="min-w-0 flex-1 truncate text-[length:var(--app-font-size-ui-sm,11px)] font-medium text-foreground/80">
            {headerLabel}
          </span>
          ...
          <CommandList className="py-0.5">
            ...
            {searchRows.length > 0 ? (
              <>
                ...
                <CommandGroup>
                  <CommandGroupLabel className="px-2 pt-1.5 pb-1 text-[length:var(--app-font-size-ui-xs,10px)] font-semibold text-muted-foreground/55">
                    Matches deeper
                  </CommandGroupLabel>
