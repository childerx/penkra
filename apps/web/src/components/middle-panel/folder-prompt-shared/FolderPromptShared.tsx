  ...
  return (
    ...
    >
      ...
      <span className="inline-flex min-w-0 items-start">
        <span
          className="min-w-0 truncate whitespace-nowrap border-b border-current leading-[35px] @max-[407px]:max-w-full @max-[407px]:leading-[32px] @max-[297px]:leading-[30px]"
          data-pencil-node="qNEBL"
        >
          {folderName}
        </span>
        <span>?</span>
