...
export interface VoiceRecorderSharedProps {
  disabled?: boolean;
...
export function VoiceRecorderShared(props: VoiceRecorderSharedProps) {
          ...
          {visibleLevels.map((level, index) => {
            ...
            return (
              <span
                ...
                style={{ width: `${BAR_WIDTH_PX}px`, height: `${height}px` }}
              />
            );
          })}
        </div>
