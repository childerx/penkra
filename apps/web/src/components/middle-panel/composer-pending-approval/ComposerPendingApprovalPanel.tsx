...
import { type ApprovalRequestId, type ProviderApprovalDecision } from "@penkra/contracts";
import { type KeyboardEvent } from "react";
import { type PendingApproval } from "../../../session-logic";
import { cn } from "~/lib/utils";
import { ComposerChoiceRow, type ComposerChoiceTone } from "../../chat/ComposerChoiceRow";
...
// Order and copy mirror the approved composer approval state.
const APPROVAL_ACTIONS: ReadonlyArray<ApprovalAction> = [
  ...
  },
  {
    ...
    description: "Remember until this thread ends",
    tone: "neutral",
  },
  {
    decision: "decline",
...
const KIND_PROMPT: Record<PendingApproval["requestKind"], string> = {
  ...
  "file-change": "Make this file change?",
};
