// FILE: pullRequestSummary.logic.ts
// Purpose: Pure check-rollup, review-comment, and agent-fix-prompt helpers.
...
// the PR out under a different local branch name (e.g. `penkra/pr-N/<branch>`).
