...
export function ThemePickerShared({
  ...
  return (
    <Popover>
      <PopoverTrigger
        className={cn(
          "flex h-7 w-[118px] cursor-pointer items-center gap-1.5 rounded-lg border border-[var(--color-border)] bg-[var(--color-background-control-opaque)] px-2.5 text-xs text-[var(--color-text-foreground)] outline-none hover:bg-[var(--color-background-button-secondary-hover)] focus-visible:border-[var(--color-border-focus)] disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
