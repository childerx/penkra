import type { GitResolvePullRequestResult } from "@penkra/contracts";
  ...
  return (
    <>
      ...
      <DialogPanel className="space-y-4">
        ...
        {isResolving ? (
          <div className="flex items-center gap-2 text-muted-foreground text-[length:var(--app-font-size-ui,12px)]">
