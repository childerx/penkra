(function () {
  ...
  function nodeMatchesSpec(node, spec) {
    return (
      ...
      ((node.namespaceURI === XHTML_NS && spec.type === node.tagName.toLocaleLowerCase()) ||
  ...
  class DOMVNode extends VNodeBase {
    ...
    insertNode(context) {
      ...
      const shouldInsert = !(
        parent === this.node.parentElement && sibling === this.node.previousSibling
      );
      if (shouldInsert) {
  ...
  function Control(props, ...content) {
    return m$1("span", { class: ["control-group__control", props.class] }, ...content);
  }
  function Description(props, ...content) {
    return m$1("span", { class: ["control-group__description", props.class] }, ...content);
  }
  ...
  function VirtualScroll(props) {
    ...
    function renderContent(root, scrollToIndex) {
      ...
      const containerHeight =
        document.documentElement.clientHeight - root.getBoundingClientRect().top;
      let focusedIndex = -1;
  ...
  function Slider(props) {
    ...
    function onPointerDown(startEvt) {
      ...
      function onPointerMove(e) {
        ...
        onPreview === null || onPreview === void 0 ? void 0 : onPreview(value);
      }
      function onPointerUp(e) {
        unsubscribe();
        const value = getEventValue(e);
  ...
  function TextList(props) {
    ...
    if (
      node &&
      props.isFocused &&
      (!prevProps || !prevProps.isFocused || prevProps.values.length < props.values.length)
    ) {
      focusLastNode();
    }
    ...
    return m$1(
      ...
      m$1(
        "g",
        {
          ...
          fill: (_a = props.color) !== null && _a !== void 0 ? _a : "currentColor",
        },
        m$1("path", {
  ...
  function getSiteToggleData(props) {
    ...
    const toggleHasEffect =
      data.settings.enableForProtectedPages || (!tab.isProtected && !pdf) || tab.isInjected;
    const isSiteEnabled =
      isURLEnabled(tab.url, data.settings, tab, data.isAllowedFileSchemeAccess) &&
    ...
    const urlText = pdf
      ...
      : displayHost
          ...
          .reduce(
            (elements, part, i) =>
              elements.concat(i > 0 ? m$1("wbr", null) : null, `${i > 0 ? "." : ""}${part}`),
            [],
          );
  ...
  function getCurrentThemePreset(props) {
    ...
    const preset = custom
      ? null
      : props.data.settings.presets.find(({ urls }) => isURLInList(props.data.activeTab.url, urls));
    ...
    return m$1(
      ...
      m$1(
        ...
        m$1(
          ...
          "Pay for using ",
          m$1("strong", { class: "m-donate-button__darkreader" }, "Dark Reader"),
        ),
      ),
      m$1("label", { class: "m-donate-description" }, "Please support our work"),
    );
  }
  ...
  function CustomSettingsToggle({ data, actions }) {
    ...
    const urlText = host
      .split(".")
      .reduce(
        (elements, part, i) => elements.concat(m$1("wbr", null), `${i > 0 ? "." : ""}${part}`),
        [],
      );
    return m$1(
      Button,
        ...
        data.uiHighlights.includes("anniversary")
          ? m$1(
              ...
              m$1(
                ...
                m$1("span", { class: "donate-link__text" }, getLocalMessage("pay_for_using")),
              ),
              m$1(
                "p",
                { class: "header__more-settings__description" },
      ...
      m$1(
        ...
        m$1(
          ...
          m$1(CheckBox, {
            ...
            onchange: (e) =>
              changeAutomationMode(e.target.checked ? AutomationMode.TIME : AutomationMode.NONE),
          }),
          m$1(TimeRangePicker, {
        ...
        m$1(
          ...
          m$1(CheckBox, {
            ...
            onchange: (e) =>
              changeAutomationMode(e.target.checked ? AutomationMode.SYSTEM : AutomationMode.NONE),
          }),
          m$1(
            Button,
            {
      ...
      m$1(
        ...
        m$1(
          ...
          m$1(
            ...
            m$1("span", { class: "more-settings__settings-button__icon" }, m$1(SettingsIcon, null)),
            m$1(
              "span",
    ...
    return m$1(
      ...
      m$1(
        ...
        m$1(
          ...
          m$1("span", { class: "news__header__text__dark-reader" }, "Dark Reader"),
          " ",
          m$1("span", { class: "news__header__text__mobile" }, "Mobile"),
          m$1("i", { class: "news__header__text__phone-icon" }, m$1(PhoneIcon, null)),
        ),
        m$1("span", { class: "news__close", role: "button", onclick: onClose }, "\u2715"),
      ),
      m$1(
        ...
        m$1(
          ...
          m$1(
            ...
            m$1("div", { class: "news__mobile__text" }, getLocalMessage("mobile_text")),
            m$1(
              "div",
  ...
  function MobileLinksButton({ active, onClick }) {
    return m$1(
      ...
      m$1(
        ...
        m$1("i", { class: "news-button__phone-icon" }, m$1(PhoneIcon, null)),
  ...
  function Body(props) {
    ...
    const v =
      (_b = (_a = props.installation) === null || _a === void 0 ? void 0 : _a.version) === null ||
      _b === void 0
        ? void 0
