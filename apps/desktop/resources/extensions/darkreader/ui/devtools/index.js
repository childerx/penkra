(function () {
  ...
  function ConfigEditor(props) {
    ...
    return m$1(
      ...
      m$1(
        "div",
        { class: "buttons" },
        props.delete ? m$1(Button, { onclick: showDeleteDialog }, "Delete") : null,
        props.reset ? m$1(Button, { onclick: showResetDialog }, "Reset changes") : null,
  ...
  function Body(props) {
    ...
    data.settings.previewNewestDesign ? "Switch to old design" : "Preview new design";
        ...
        m$1(
          ...
          m$1(ConfigEditorTabs, {
            ...
            create: (url) => {
              return {
                url: [url],
                invert: [".example_icon-selector-to-invert", 'img[src*="image-to-invert.png"]'],
                css: [
  ...
  function renderBody(data, devToolsData, actions) {
    sync(document.body, m$1(Body, { data: data, devtools: devToolsData, actions: actions }));
  }
