(function () {
  ...
  function KeyIcon(props) {
    ...
    return m$1(
      ...
      m$1(
        "g",
        {
          stroke: (_a = props.color) !== null && _a !== void 0 ? _a : "currentColor",
          "stroke-width": "2",
        },
  ...
  function ActivationTab(props) {
    ...
    if (!props.data.uiHighlights.includes("anniversary")) {
      return m$1(
        ...
        m$1("div", { class: "activation__success-message" }, "Activation was successful"),
        m$1(
          ControlGroup$1,
          null,
          m$1(
    ...
    const activate = () => {
      ...
      const email =
        (_b =
          (_a = store.emailTextElement) === null || _a === void 0 ? void 0 : _a.value.trim()) !==
          null && _b !== void 0
          ? _b
          : "";
      const key =
        (_d = (_c = store.keyTextElement) === null || _c === void 0 ? void 0 : _c.value.trim()) !==
          null && _d !== void 0
          ? _d
          : "";
      store.errorMessage = "";
        ...
        m$1(
          ...
          m$1(TextBox, {
            ...
            onkeypress: (e) => {
              var _a;
              if (e.key === "Enter") {
                (_a = store.keyTextElement) === null || _a === void 0 ? void 0 : _a.focus();
              }
            },
          }),
        ),
        ...
        m$1(
          ...
          m$1(TextBox, {
            ...
            onkeypress: (e) => {
              var _a;
              if (e.key === "Enter") {
                (_a = store.keyTextElement) === null || _a === void 0 ? void 0 : _a.blur();
                activate();
              }
            },
          }),
  ...
  function ResetSettings(props) {
    ...
    return m$1(
      ...
      m$1(
        ControlGroup$1.Control,
        null,
        m$1(ResetButton, { onClick: showDialog }, "Reset settings", dialog),
      ),
  ...
  function AutomationTab(props) {
    ...
    return m$1(
      ...
      m$1(
        ...
        m$1(ControlGroup$1.Description, null, getLocalMessage("set_active_hours")),
      ),
      m$1(
        ControlGroup$1,
        null,
        ...
        m$1(ControlGroup$1.Description, null, getLocalMessage("set_location")),
      ),
      m$1(
        ControlGroup$1,
        null,
        ...
        m$1(
          ...
          !isMatchMediaChangeEventListenerBuggy
            ? null
            : [m$1("br", null), getLocalMessage("system_dark_mode_chromium_warning")],
        ),
      ),
      m$1(
        ControlGroup$1,
  ...
  function HotkeysTab(props) {
    ...
    return m$1(
      ...
      m$1(
        ...
        m$1(ControlGroup$1.Description, null, "Enable/disable the extension"),
      ),
      m$1(
        ControlGroup$1,
        null,
        ...
        m$1(ControlGroup$1.Description, null, "Toggle the current website"),
      ),
    );
  }
      ...
      m$1(
        ...
        m$1(
          ...
          m$1(
            ...
            m$1("span", { class: "clear-site-list-button__icon" }, m$1(DeleteIcon, null)),
            "Clear site list",
          ),
          dialog,
        ),
      ),
      m$1(ControlGroup$1.Description, null, "Remove all sites from the list"),
    );
  }
  ...
  function TabPanel(props, ...children) {
    ...
    function createTabButton(tabSpec) {
      ...
      return m$1(
        Button,
        {
          ...
          onclick: (_a = tabSpec.props.onClick) !== null && _a !== void 0 ? _a : onClick,
        },
        m$1(
          "span",
          {
    ...
    return m$1(
      ...
      m$1("div", { class: "settings-tab-panel__buttons" }, ...children.map(createTabButton)),
      m$1(
        "div",
