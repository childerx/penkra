...
// Purpose: Resolves Penkra's Electron userData paths and completes bridge profile repair.
 ...
 *
 * The bridge manifest identifies the exact sibling profile that supplied the Penkra profile.
