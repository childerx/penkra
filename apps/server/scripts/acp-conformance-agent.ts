...
const logPath = process.env.PENKRA_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.PENKRA_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "penkra-official-sdk-conformance-agent" })
