import { EventId, IsoDateTime, NonNegativeInt, ThreadId } from "@penkra/contracts";
...
>()(
  "penkra/persistence/Services/OrchestrationEventDeliveries/OrchestrationEventDeliveryRepository",
) {}
