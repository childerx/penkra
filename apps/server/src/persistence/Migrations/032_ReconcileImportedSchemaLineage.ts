 ...
 * names. Because the migrator skips by ID, Penkra migrations 17-31 never run
 ...
 * Penkra migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Penkra installs (every column already
