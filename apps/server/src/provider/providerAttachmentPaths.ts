...
import type { ChatAttachment, ProviderKind, ThreadId } from "@penkra/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("penkra.providerAttachmentStoragePath");
