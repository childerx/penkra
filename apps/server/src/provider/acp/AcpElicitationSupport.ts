...
// Purpose: Bridges ACP form elicitation schemas to Penkra's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Penkra's composer.
