...
export const takeCursorPenkraHarnessPolicyTextPart = (
...
// forever. Generous by design; override with PENKRA_CURSOR_TURN_IDLE_TIMEOUT_MS.
const CURSOR_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "PENKRA_CURSOR_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 600_000,
});
  ...
  return Effect.gen(function* () {
    ...
    const sendTurn: CursorAdapterShape["sendTurn"] = (input) =>
      Effect.gen(function* () {
        ...
        const harnessPolicy = takeCursorPenkraHarnessPolicyTextPart(
          ctx,
