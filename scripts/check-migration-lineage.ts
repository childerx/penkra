...
const HANDLED_RELEASED_DIVERGENCES: readonly MigrationLineageAllowance[] = [
  ...
  { id: 74, name: "ExternalMcpIntegrations" },
  { id: 75, name: "ExternalMcpActiveCapacity" },
  { id: 76, name: "ExternalMcpHardening" },
  { id: 77, name: "ExternalMcpCompensatingCapacity" },
  { id: 78, name: "ExternalMcpLiveTurnCapacity" },
  { id: 80, name: "ExternalMcpProjectScope" },
  { id: 81, name: "AutomationProposals" },
  { id: 82, name: "AutomationMemory" },
